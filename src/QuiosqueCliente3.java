...
public class QuiosqueCliente3 {
    ...
    public static void capturarSnapshotLocal(String quiosqueId) {
    System.out.println("----- SNAPSHOT CLIENTE -----");
    System.out.println("ID Quiosque: " + quiosqueId);
    System.out.println("----------------------------");
}
    ...
    private static void fazerPedido(String quiosqueId, Scanner scanner) {
        ...
        switch (metodo) {
            case "1": metodoPagamento = "CARTAO_CREDITO"; break;
            case "2": metodoPagamento = "CARTAO_DEBITO"; break;
            case "3": metodoPagamento = "DINHEIRO"; break;
            case "4": metodoPagamento = "VALE_REFEICAO"; break;
            default: 
        ...
        try (
            ...
            relogioLamport++;
            // Envia o pedido com o timestamp
            out.println(mensagemPedido + "|LAMPORT:" + relogioLamport);

            String resposta = in.readLine();
            System.out.println("\nResposta do servidor: " + resposta);

            // Processa o Lamport recebido na resposta
            String[] partesResposta = resposta.split("\\|LAMPORT:");
            String respostaMsg = partesResposta[0];
            ...
            String[] partes = respostaMsg.split("\\|");
